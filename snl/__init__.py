...
logformatter = ColoredFormatter("\x1b[2;37m%(asctime)s \x1b[%(color1)sm%(levelname)-8s\x1b[m "
                                "\x1b[4m%(name)s\x1b[m \x1b[%(color2)sm%(indentedmessage)s\x1b[m")
...
from .SIPBNF import URI  # noqa: F401 E402
from .Message import SIPMessage, SIPResponse, SIPRequest, REGISTER, INVITE  # noqa: F401 E402
from .Message import ACK, BYE, CANCEL, OPTIONS, INFO, PRACK, UPDATE  # noqa: F401 E402
from .Message import SUBSCRIBE, NOTIFY, PUBLISH, REFER, MESSAGE  # noqa: F401 E402
from .Transport import Transport  # noqa: F401 E402
from .UA import SIPPhoneClass  # noqa: F401 E402
from .Media import Media  # noqa: F401 E402
from .MSRP import MSRP  # noqa: F401 E402
from .Pcap import Pcap  # noqa: F401 E402
from . import Header  # noqa: F401 E402
from .Tags import settags  # noqa: F401 E402
from .Utils import TimedLoop  # noqa: F401 E402
